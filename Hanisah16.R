...
#---------------------------- Import functions ------------------------------------------------------- 
#set directorate 
Hanisah <- read_excel("C:/Users/User/Desktop/TrainingData.xlsx")        c#.xlsx format
str(Hanisah)
...
library(tidyr)
Hanisah16 <-read_excel("C:/Users/User/Desktop/thursday.xlsx") 
print(Hanisah16)
# use gather()function to make data longer
long <- Hanisah16 %>%  
  gather(`NAME OF PATIENT`, `AGE (YRS)` )
print(long)
# use separate()function 
  separate_data <- Hanisah16 %>%  
  separate(`NAME OF PATIENT`, c("firstName","secondName"))
separate_data
